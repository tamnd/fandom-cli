...
Most of these come down to network reality or how fandom serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

fandom rate-limits like any public site. fandom already paces
...
Where a surface is gated, fandom reads a cookie or token you supply
...
`fandom`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what fandom actually did
